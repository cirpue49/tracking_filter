...
#ifndef HELP_FILTER_UKF_H
#define HELP_FILTER_UKF_H
...
//    std::ofstream NISvals_laser_rm_;
    ...
    void Initialize(MeasurementPackage meas_package, VectorXd z);

    double CalculateGauss(VectorXd z, int sensorInd, int modelInd);

    void UpdateModeProb(VectorXd z);
     ...
     */
    void ProcessMeasurement(MeasurementPackage meas_package, VectorXd z);

    void PostProcessMeasurement(VectorXd z);
     ...
     */
    void UpdateLidar(MeasurementPackage meas_package, int modelInd);
